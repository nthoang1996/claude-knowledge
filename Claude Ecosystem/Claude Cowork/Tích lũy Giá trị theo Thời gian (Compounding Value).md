...
```mermaid
graph LR
    A["Global instructions<br/>quy tắc dùng cho MỌI hội thoại"] --> B["Projects<br/>khi có luồng việc lặp lại,<br/>có tài liệu riêng"]
    B --> C["Skills<br/>khi phải giải thích lại<br/>cùng 1 quy trình nhiều lần"]
    C --> D["Plugins<br/>khi quy trình đã chuẩn hóa,<br/>muốn chia sẻ cho cả team"]
```
