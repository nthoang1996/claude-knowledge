...
- **Primitives** — các thành phần nguyên bản gọi qua [[REST API]]/[[SDKs]]: Messages API (chọn model — xem [[Model Tiers]]), [[Tool Use (Function Calling)|Tool use]] (cơ chế lặp nhiều lượt: xem [[Vòng lặp Agent]]), xử lý tệp, tìm kiếm web, thực thi code, tích hợp [[Connectors (MCP)|MCP servers]], skills. Định hình logic/khả năng tương tác cơ bản.
